...
const appCfg = {
    routes:[
        ...
        {navItem:true, exact:true, path:"/bedroom",name:"Bedroom",view:<Bedroom/>},
        {navItem:true, exact:true, path:"/kitchen",name:"Kitchen",view:<Kitchen/>},
        {navItem:true, exact:true, path:"/livingroom",name:"Living room",view:<Livingroom/>},        
